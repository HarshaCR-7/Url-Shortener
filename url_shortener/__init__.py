...
def create_app(config_file='settings.py'):
    ...
    if ENV == 'dev':  #local For Development porpose
        ...
        app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://csvwriuijpgbki:f00571a2992db6f219b352125c7c87633baf0e1de5999a900210ad6b1f6829c7@ec2-50-19-160-40.compute-1.amazonaws.com:5432/d36uf0phsvofer'
